  ...
  outputs = { self, nixpkgs }:
    let
      ...
      toolchain = pkgs.stdenv.mkDerivation {
        ...
        buildInputs = [ pkgs.stdenv.cc.cc.lib pkgs.ncurses5 pkgs.expat pkgs.python27 ];
        dontConfigure = true;
        dontBuild = true;
        dontStrip = true;
        installPhase = ''
      ...
      tools = [ toolchain pythonEnv pkgs.cmake pkgs.ninja pkgs.git pkgs.protobuf pkgs.pkg-config ];
